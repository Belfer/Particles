// Utility header for the sf::Vector2f class.
 ...
 * @return a onto b
 */
static inline Vec2 project (const Vec2& a, const Vec2& b)
{
    const float t = dot(a, b) / (b.x*b.x + b.y*b.y);
 ...
 * @return res = v * R
 */
static inline Vec2 rotate (const Vec2& v, float angle)
{
    Vec2 res;
    rotate(res, v, angle);
    return res;
